export default () => {
    ...
    const team = [
        {
            avatar: "https://d2az3zd39o5d63.cloudfront.net/linkedin-profile-picture-squinch.jpg",
        ...
        },
        {
            ...
            title: "Junior Compounder",
            desc: "Compounder - Intern",
            linkedin: "javascript:void(0)",
            twitter: "javascript:void(0)",
        },
        {
    ...
    return (
        <section className="py-14">
            <div id="team" className="max-w-screen-xl mx-auto px-4 text-center md:px-8">
